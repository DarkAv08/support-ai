        ...
        <div className='min-h-screen bg-linear-to-br from-white to-zinc-50 text-zinc-900 overflow-x-hidden'>
            <motion.div
                ...
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    ...
                    </div> : <button className='px-5 py-2 rounded-full bg-black text-white text-sm font-medium hover:bg-zinc-800 transition disabled:opacity-60 flex items-center gap-2' onClick={handleLogin} disabled={loading}>{loading?"Loading...":"Login"}</button>
                    }
                </div>
            </motion.div>
                ...
                <div className='max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center'>
                    <motion.div
                        ...
                        <h1 className='text-4xl md:text-5xl font-semibold leading-tight'>
                            ...
                            Built for Mordern Websites
                        </h1>
                        <p className='mt-6 text-lg text-zinc-600 max-w-xl'>
                            Add a powerfull AI chatbot to your website in minutes.
                        ...
                        <div className='mt-10 flex gap-4'>
                            ...
                            <a href='#feature' className='px-7 py-3 rounded-xl border-zinc-300 text-zinc-700 font-medium hover:bg-zinc-100 transition'>Learn More</a>
                        </div>
            ...
            <section id='feature' className='bg-zinc-50 py28 px6 border-t border-t-zinc-200'>
